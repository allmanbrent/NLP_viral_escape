...
def get_model(args, seq_len, vocab_size,
    ...
    elif args.model_name == 'esm1_t6_43M_UR50S':
    ...
    elif args.model_name == 'esm2_t30_150M_UR50D':
        from fb_model import FBModel
        model = FBModel(
            'esm2_t30_150M_UR50D',
            repr_layer=[-1],
