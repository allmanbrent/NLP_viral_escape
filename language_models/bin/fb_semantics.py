...
def predict_sequence_prob_fb(args,
    ...
    data_loader = torch.utils.data.DataLoader(
        dataset, collate_fn=alphabet.get_batch_converter(args.max_len),
...
def fb_semantics(args,model, repr_layers, alphabet, seq_to_mutate, escape_seqs,
    ...
    y_pred = predict_sequence_prob_fb(args,
    ...
    base_embedding = embed_seqs_fb(args,
    ...
    for batchi in range(n_batches):
        ...
        prob_seqs_batch = embed_seqs_fb(args,
