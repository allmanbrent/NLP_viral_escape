...
BA1 = pd.read_csv("../BA1_scores.csv")
Delta = pd.read_csv("../Delta_scores.csv")
Starr = pd.read_csv("../Starr_scores.csv")
...
BA1 = make_predictors(BA1, None, None, scores=False)
Delta = make_predictors(Delta, None, None, scores=False)
Starr = make_predictors(Starr, None, None, scores=False)
...
spike.to_csv("../results/summaries_with_scores/full_spike_evescape.csv",
             index=False)
BA1.to_csv("../results/summaries_with_scores/full_BA1_evescape.csv",
             index=False)
Delta.to_csv("../results/summaries_with_scores/full_Delta_evescape.csv",
             index=False)
Starr.to_csv("../results/summaries_with_scores/full_Starr_evescape.csv",
             index=False)
#lassa.to_csv(
...
BA1_site = make_site(BA1)
Delta_site = make_site(Delta)
...
spike_site.to_csv(
    ...
    index=False)
BA1_site.to_csv(
    '../results/summaries_with_scores/full_BA1_evescape_sites.csv',
    index=False)
Delta_site.to_csv(
    '../results/summaries_with_scores/full_Delta_evescape_sites.csv',
    index=False)
#lassa_site.to_csv(
