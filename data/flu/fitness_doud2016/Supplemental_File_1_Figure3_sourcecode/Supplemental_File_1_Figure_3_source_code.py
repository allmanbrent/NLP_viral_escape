...
This script can be run within pymol.

First navigate (using 'cd') to the directory containing:
1) this script, 
2) the preferences file (Supplemental_File_2_HApreferences_rescaled.txt), and
...
def main():
    ...
    preferences_file = 'Supplemental_File_2_HApreferences_rescaled.txt' 
